...
/// are looked up in a taxonomy, and the ID, name and rank of the taxon is written out separated by
/// commas.
///
/// The `-H` flag can be used to suppress the CSV header.
///
///     $ cat input.fa
///     >header1
///     2026807
...
///     1598
///     1883
///     $ umgap taxonomy -H taxons.tsv < input.fa
///     >header1
...
///     $ cat input2.fa
///     888268
///     $ umgap taxonomy -a taxons.tsv < input2.fa
