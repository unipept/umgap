...
gap_pen28 <- c(which(mat[,"gap_pen"]==0.2),which(mat[,"gap_pen"]==0.5))
...
gap_pen28 <- c(which(mat.mrl[,"gap_pen"]==0.2),which(mat.mrl[,"gap_pen"]==0.5))
...
gap_pen28M <- c(which(matM[,"gap_pen"]==0.2),which(matM[,"gap_pen"]==0.5))
...
gap_pen28M <- c(which(matM.mrl[,"gap_pen"]==0.2),which(matM.mrl[,"gap_pen"]==0.5))
...
* zodra de seedlengte en type model vastliggen zorgt de grootte van gaps voor een daling in sensitiviteit en een stijging in precisie
  ...
  scatterplot(mean_prec~gap_pen|length_type,data=data_frame,smoother=FALSE,cex.lab=0.5, cex.axis=0.5,cex = 0.5,main="HiSeq")
  scatterplot(mean_sens~gap_pen|length_type,data=data_frame,smoother=FALSE,cex.lab=0.5, cex.axis=0.5,cex = 0.5,main="HiSeq")
...
summary(beiden_fout[beiden_fout[,"correct"]=="M_abscessus",])
