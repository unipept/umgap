...
def read_csv(infile):
	for line in open(infile):
		...
		data, rank, tool, real, tp, fp, tn, fn, *_ = line.split(',')
...
def show(imgfile, rank, infile='metabenchmark.tsv'):
...
tools = [ 'umgap tryptic precision'
        ...
        , 'umgap new tryptic sensitivity'
        , 'umgap high sensitivity'
        , 'umgap max sensitivity'
        , 'clark'
        ]

def averages(rank, data=None, infile='metabenchmark.tsv'):
